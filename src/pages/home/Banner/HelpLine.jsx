    ...
    <section className="py-6 dark:bg-gray-800 -mt-36">
      <div className="container flex flex-col justify-center p-4 mx-auto">
        <div className="grid mx-auto gap-32 grid-cols-1  lg:grid-cols-3 sm:grid-cols-2">
          <div className="card w-60  h-60 flex justify-center items-center  rounded-full shadow-xl">
          ...
          <div className="card w-60 -mt-10 bg-[#455a64] text-white h-60 flex justify-center items-center  rounded-full shadow-xl">
            <div className="flex-col px-2 flex justify-center items-center w">
              <h2 className="text-8xl">
                <AiFillCar />
              </h2>
